...
| :--- | :--- | :--- |
| **[StockSim](https://github.com/TitanStar73/stocksim)** | 📈 **FinTech** | Stock market simulator using **real-time NYSE data** with persistent portfolio tracking and net worth calculations. |
| **[Better Cordova](https://github.com/TitanStar73/better-cordova)** | 📱 **DevOps** | Automation wrapper for Apache Cordova that streamlines converting HTML/CSS/JS into cross-platform mobile apps. **Converting a website to an app can take as little as 5 minutes**! |
